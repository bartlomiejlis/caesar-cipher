# caesar-cipher
A program that encrypts text entered from the keyboard with a Caesar cipher.

Live demo [_here_](https://replit.com/@BartlomiejLis/caesar-cipher).
...
```bash
  git clone https://github.com/bartlomiejlis/caesar-cipher.git
```
